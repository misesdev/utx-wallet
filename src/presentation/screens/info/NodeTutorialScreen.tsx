...
const SECTIONS: Section[] = [
  { icon: 'info',     titleKey: 'nodeTutorial.s1Title', bodyKey: 'nodeTutorial.s1Body' },
  { icon: 'node',     titleKey: 'nodeTutorial.s2Title', bodyKey: 'nodeTutorial.s2Body', accent: true, isCode: true },
  { icon: 'settings', titleKey: 'nodeTutorial.s3Title', bodyKey: 'nodeTutorial.s3Body' },
  { icon: 'network',  titleKey: 'nodeTutorial.s4Title', bodyKey: 'nodeTutorial.s4Body' },
  { icon: 'edit',     titleKey: 'nodeTutorial.s5Title', bodyKey: 'nodeTutorial.s5Body' },
  { icon: 'check',    titleKey: 'nodeTutorial.s6Title', bodyKey: 'nodeTutorial.s6Body', accent: true },
  { icon: 'security', titleKey: 'nodeTutorial.s7Title', bodyKey: 'nodeTutorial.s7Body' },
];

export function NodeTutorialScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: theme.colors.background, paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <AppText variant="subtitle" style={styles.headerTitle}>{t('nodeTutorial.title')}</AppText>
      ...
      >
        ...
        >
          <View style={[styles.heroIconWrap, { backgroundColor: theme.colors.accent + '22', borderRadius: theme.radii.lg }]}>
            <AppIcon name="node" size={32} color={theme.colors.accent} />
          </View>
          <AppText variant="title" style={styles.heroTitle}>{t('nodeTutorial.heroTitle')}</AppText>
          <AppText variant="body" color="muted" style={styles.heroDesc}>{t('nodeTutorial.heroDesc')}</AppText>
        </View>
...
function TutorialCard({ icon, title, body, accent, isCode, stepNumber }: TutorialCardProps) {
  const { theme } = useTheme();
