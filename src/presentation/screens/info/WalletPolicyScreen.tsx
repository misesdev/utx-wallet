...
const SECTIONS: Section[] = [
  { icon: 'info',         titleKey: 'walletPolicy.s1Title', bodyKey: 'walletPolicy.s1Body' },
  { icon: 'key',          titleKey: 'walletPolicy.s2Title', bodyKey: 'walletPolicy.s2Body', accent: true },
  { icon: 'sync',         titleKey: 'walletPolicy.s3Title', bodyKey: 'walletPolicy.s3Body' },
  { icon: 'network',      titleKey: 'walletPolicy.s4Title', bodyKey: 'walletPolicy.s4Body' },
  { icon: 'accounts',     titleKey: 'walletPolicy.s5Title', bodyKey: 'walletPolicy.s5Body' },
  { icon: 'security',     titleKey: 'walletPolicy.s6Title', bodyKey: 'walletPolicy.s6Body', accent: true },
];

export function WalletPolicyScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: theme.colors.background, paddingTop: insets.top }]}>
      <View style={styles.header}>
        ...
        <AppText variant="subtitle" style={styles.headerTitle}>{t('walletPolicy.title')}</AppText>
      ...
      >
        ...
        >
          ...
          <AppText variant="title" style={styles.heroTitle}>{t('walletPolicy.heroTitle')}</AppText>
          <AppText variant="body" color="muted" style={styles.heroDesc}>{t('walletPolicy.heroDesc')}</AppText>
        </View>
