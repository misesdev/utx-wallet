...
import {
  WalletScreen,
} from '../../../src/presentation/screens/wallet/WalletScreen';
import { accountSyncFormat, addressSyncFormat } from '../../../src/presentation/screens/wallet/components/SyncPill';
...
describe('WalletScreen', () => {
  ...
  describe('Wallet name and balance rendering', () => {
    it('renders the wallet name as screen title', () => {
      const screen = renderWithTheme(<WalletScreen />);
